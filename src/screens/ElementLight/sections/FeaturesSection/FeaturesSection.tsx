        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {steps.map((step, idx) => {
            ...
            return (
              <div 
                key={idx} 
                className={`group relative bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 ${colorClasses.border} transform hover:-translate-y-2`}
              >
                {/* Step Number */}
                <div className="absolute -top-4 left-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">
                  {idx + 1}
                </div>
                
                {/* Icon */}
                <div className="flex justify-center mb-6 mt-4">
                  <div className={`p-4 bg-gray-50 rounded-full ${colorClasses.bg} transition-colors duration-300`}>
                    {step.icon}
                  </div>
                </div>
                ...
                <div className="text-center">
                  <h3 className={`font-bold text-xl mb-3 text-gray-900 ${colorClasses.text} transition-colors duration-300`}>
                    {step.title}
                  </h3>
